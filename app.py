...
MYSQL_HOST = '34.134.9.114'  # either the IP address or the Unix socket path
MYSQL_USER = 'saitejapoluka249'           # Database username (e.g., 'root')
MYSQL_PASSWORD = 'Sai3365@'       # Database password
MYSQL_DB = 'community_event_organizer'                 # Database name (e.g., 'mydatabase')
...
EMAIL_USER = "saitejapoluka249@gmail.com"  # Replace with your email address
EMAIL_PASSWORD = "grse eyba cfqr yelx"  # Replace with your email password or use an app-specific password
